...
var data_one = function () {
    return {
        login: function () { return "login module"; },
        logout: function () { return "loout module"; },
        setCredential: function () { return "setcredenical  module"; },
        clearCredential: function () { return "clear module"; }
    };
};
...
var calculator = function () {
    return {
        ...
        sub: function (arg1, arg2) { return arg1 - arg2; },
        mul: function (arg1, arg2) { return arg1 * arg2; },
        div: function (arg1, arg2) { return arg1 / arg2; }
    };
};
...
var subjects = function (obj1, obj2, obj3) {
    document.write(obj1.sub_one + "<br>" +
        obj2.sub_two + "<br>" +
        obj3.sub_three + "<br>");
};
subjects({ "sub_one": "angularjs" }, { "sub_two": "nodejs" }, { "sub_three": "js" });
